...
function Header() {
  ...
  return (
    <div className='relative flex mx-auto my-5 justify-center items-center bg-black bg-opacity-10 py-8 shadow-2xl shadow-black-400 w-5/6 rounded-lg max-sm:py-2 dark:shadow-slate-800 dark:shadow-slate-800'>
      <h1 className="outfit-bold text-5xl text-black geo-sans text-black text-center max-lg:text-4xl max-md:text-3xl max-sm:text-3xl dark:text-white">WEATHER AND FORECAST APP</h1>
