...
function Display() {
    ...
    return (
        ...
        <div className='mx-auto h-5/6 bg-black bg-opacity-10 justify-center flex py-10 shadow-2xl shadow-black-400 w-5/6 rounded-lg       max-md:grid max-md:h-auto       max-sm:h-auto max-sm:grid max-sm:py-3'>
            <div className='w-5/12      max-md:w-full        max-sm:container max-sm:mx-auto max-sm:h-4/6'>
                <div className='px-10 flex items-center bg-white bg-opacity-10 h-1/6 rounded-lg shadow-lg shadow-black-400       max-lg:pb-6 max-lg:mx-auto max-lg:my-auto        max-md:pb-0 max-md:mx-auto max-md:h-16 max-md:px-0        max-sm:h-12 max-sm:w-full max-sm:px-6'>
                ...
                <div className={`bg-white bg-opacity-10 rounded-lg shadow-lg shadow-black-400 h-2/6    max-lg:h-auto         max-sm:h-16`}>
                    {details && <div className='flex justify-start     '>
                        ...
                        <div className='pt-10 pl-3    max-sm:pt-1 max-sm:inline-block max-sm:align-middle'>
                            <p className='font-thin text-3xl    max-lg:text-2xl      max-md:text-3xl      max-sm:text-base max-sm:font-light'>{details.main.temp}°C</p>
                            <p className='font-thin text-3xl      max-lg:text-2xl      max-md:text-3xl      max-sm:text-base max-sm:font-light'>{details.weather[0].main}</p>
                        </div>
                        <div className='pt-12 pl-8         max-lg:pt-10 max-lg:mx-auto max-lg:pb-10 max-lg:flex-wrap max-lg:flex   max-md:block  max-sm:pt-1 max-sm:inline-block max-sm:align-middle'>
                            <p className='font-thin text-xl     max-lg:text-lg      max-md:text-2xl       max-sm:text-base max-sm:font-light'>{formattedDate}</p>
                            <p className='font-thin text-xl     max-lg:text-lg      max-md:text-xl       max-sm:text-base max-sm:font-light'>{convertToStandardTime(details.timezone)}</p>
                        </div>
                    </div>}
                </div>
                <div className="py-2 max-sm:py-1"></div>
            ...
            <div className="w-6/12      max-md:w-full max-md:mt-4    max-sm:mt-2 max-sm:mt-0 max-sm:grid-cols-none max-sm:w-72 max-sm:mx-auto max-sm:h-4/6">
                <div>
                    {details ? <div className='h-full text-xl font-thin flex justify-between items-center     max-lg:text-base       max-md:text-lg               max-sm:px-1 max-sm:text-xs max-sm:font-light'>
                        ...
                        :
                        <div className='bg-white w-full bg-opacity-10 h-24 rounded-lg shadow-lg shadow-black-400          max-sm:h-24'>
                        </div>}
                </div>
                <div className="py-2 max-sm:py-1"></div>
                ...
                {details ? <div className='flex             max-md:order-first max-md:mb-2 max-md:w-auto max-md:h-12            max-sm:flex max-sm:order-none max-sm:h-auto max-sm:mb-0'>
                    <div className='text-center content-center w-2/5 bg-white bg-opacity-10 rounded-lg shadow-lg shadow-black-400'>
                        <p className='p-3 text-lg font-thin pl-3    max-lg:text-base       max-md:text-base        max-sm:text-xs max-sm:font-light'>{`${details.name}, ${details.sys.country}`}</p>
                    </div>

                    <div className='text-center content-center w-2/5 mx-2 bg-white bg-opacity-10 rounded-lg shadow-lg shadow-black-400'>
                        <p className='p-3 text-lg font-thin pl-3 pr-1    max-lg:text-base     max-md:text-base       max-sm:text-xs max-sm:font-light'>{`${details.main.temp_min.toFixed(1)}°C / ${details.main.temp_max.toFixed(1)}°C`}</p>
                    </div>

                    <div className='text-center content-center w-2/5 bg-white bg-opacity-10 rounded-lg shadow-lg shadow-black-400'>
                        <p className='p-3 text-lg font-thin pl-3 pr-1    max-lg:text-base     max-md:text-base       max-sm:text-xs max-sm:font-light'>{`Timezone: ${details.timezone}`}</p>
                    </div>
                </div>
                    :
                ...
                <div className="py-2 max-sm:py-1"></div>
                <div className='px-10 bg-white bg-opacity-10 h-4/6 rounded-lg shadow-lg shadow-black-400          max-md:h-4/6         max-sm:h-4/6 max-sm:px-1 max-sm:my-3'>
